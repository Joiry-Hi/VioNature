...
OUTPUT_DIR="$BUILD_DIR/release-en"
ZIP_NAME="VioNature_Release_EN.zip"
...
echo "========================================"
echo "  VioNature Windows Release Builder (EN)"
echo "========================================"

# Step 1: Configure
echo ""
echo "[1/5] Configuring CMake for Windows..."
mkdir -p "$BUILD_DIR"
...
# Step 3: Collect
echo ""
echo "[3/5] Collecting release files..."
rm -rf "$OUTPUT_DIR"
...
# Config (English version with tutorial_language = english)
echo "  Copying config (English)..."
cp "$ROOT/config/gameplay.cfg" "$OUTPUT_DIR/config/gameplay.cfg"
# Override tutorial language to English
...
# Clean up build artifacts that shouldn't ship
...
echo "========================================"
echo "  Done!"
echo "  English release: $BUILD_DIR/$ZIP_NAME"
echo "========================================"
