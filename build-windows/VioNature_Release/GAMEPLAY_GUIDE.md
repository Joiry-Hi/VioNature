...
- **副模式：玻璃碎片 (G)** — 5 发高速弹跳碎片，碰到墙面/地面会反弹一次
- HUD 模式标识：P / G
...
### 6. 无限手套 (GAUNT)
- **左键**：**时间停止** — 冻结所有敌人、弹幕、力场，持续约 1.5s。停止期间玩家可自由输出
- **右键**：**闪现传送** — 向面朝方向瞬间传送 12m，传送落点周围敌人被击飞
- HUD 模式标识：T（时停激活中）/ B（默认，代表 blink）
